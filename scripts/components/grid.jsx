  ...
  view() {
    return (
      ...
      >
        ...
        {this.game.pendingChip ? (
          <div
            className={clsx('chip', 'pending', this.game.pendingChip.player.color, {
          ...
          >
            <div className="chip-inner chip-inner-real"></div>
            {/* See _grid.scss for how the pending chip inner clone is used */}
            <div className="chip-inner chip-inner-clone"></div>
          </div>
        ) : null}
            ...
            <div className="grid-column">
              {_.times(this.grid.rowCount, (r) => {
                if (this.grid.columns[c][r]) {
                  ...
                  return (
                    <div
                      className={clsx('chip', chip.player.color, {
