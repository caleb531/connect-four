...
describe('AI player', () => {
  ...
  it('should block vertical opponent win (#1)', () => {
    let game = new Game();
    game.setPlayers(1);
    utils.placeChips({
      game: game,
  ...
  it('should block vertical opponent win (#2)', () => {
    let game = new Game();
    game.setPlayers(1);
    utils.placeChips({
      game: game,
  ...
  it('should block vertical opponent win (#3)', () => {
    let game = new Game();
    game.setPlayers(1);
    utils.placeChips({
      game: game,
  ...
  it('should block vertical opponent win (#4)', () => {
    let game = new Game();
    game.setPlayers(1);
    utils.placeChips({
      game: game,
